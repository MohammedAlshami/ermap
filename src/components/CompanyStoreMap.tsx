...
export function CompanyStoreMap({
  ...
  if (!geoJsonUrl) {
    return (
      <div
        className={`flex items-center justify-center rounded-xl border border-white/20 bg-white/5 text-white/60 ${className}`}
        style={{ minHeight: 360 }}
      >
  ...
  return (
    <div
      className={`rounded-xl border border-white/20 overflow-hidden bg-[#141414] ${className}`}
